...
container-test:
	...
	docker run --rm $(CONTAINER_ORGANIZATION)/$(CONTAINER_IMAGE) ansible --version
	docker run --rm $(CONTAINER_ORGANIZATION)/$(CONTAINER_IMAGE) git --version
	docker run --rm $(CONTAINER_ORGANIZATION)/$(CONTAINER_IMAGE) ssh -V
