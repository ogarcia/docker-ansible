...
docker-test:
	...
	docker run --rm $(DOCKER_ORGANIZATION)/$(DOCKER_IMAGE) ansible --version
	docker run --rm $(DOCKER_ORGANIZATION)/$(DOCKER_IMAGE) git --version
	docker run --rm $(DOCKER_ORGANIZATION)/$(DOCKER_IMAGE) ssh -V
